  ...
  const handleResend = async (event) => {
    ...
    try {
    ...
    } catch (error) {
      {
        ...
        } else if (error.code === 'auth/user-token-expired' || error.code ==='auth/too-many-requests') {
        ...
        <div className="col-lg-12 col-xl-11">
            ...
            <div className="row justify-content-center">
              <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p className="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Resend Verification Email!</p>
